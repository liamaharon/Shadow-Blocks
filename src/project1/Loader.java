...
public class Loader {
  ...
  private static Sprite stringToSprite(String text) throws SlickException {
    ...
    switch(spriteIdentifier) {
      case "floor": return new Floor(xPos,yPos);
      case "wall": return new Wall(xPos,yPos);
      case "stone": return new Stone(xPos,yPos);
      case "target": return new Target(xPos,yPos);
      case "player": return new Player(xPos,yPos);
